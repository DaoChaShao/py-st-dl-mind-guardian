...
**MindGuardian** is an **AI-powered** platform designed to support early identification of **potential mental health
risks** among **students**. It combines **deep learning** for risk prediction with a **large language model (LLM)** to
provide **personalised explanations**, **supportive guidance**, and **interactive counselling**. The platform aims to
help users better understand **psychological risk** factors through **data-driven** insights while offering an intuitive
interface for assessment and communication. MindGuardian demonstrates the integration of **predictive analytics**,
**explainable AI**, and **generative AI** to create a practical decision-support system for student mental well-being.

**DATA DESCRIPTION**
---

This **[dataset](https://www.kaggle.com/datasets/programmer3/student-psychological-crisis-risk-dataset)** contains
simulated student records designed for psychological crisis risk prediction. It includes multiple categories of
features, such as psychological indicators, behavioral patterns, physiological signals, and academic performance
metrics. The dataset provides information on factors including stress, anxiety, depression levels, sleep duration,
screen time, social media usage, attendance, and assignment performance. Each record is associated with a crisis risk
label, enabling the development of machine learning models for early risk detection, explainable analysis, and
